...
0004: 48E71F38      MOVEM.L    D3/D4/D5/D6/D7/A2/A3/A4,-(SP) ; save regs
...
0020: 4EAD01A2      JSR        418(A5)                      ; A5 jump table
0024: 2F06          MOVE.L     D6,-(A7)
0026: 486D902C      PEA        -28628(A5)
002A: 486EFFC1      PEA        -63(A6)
002E: 4EAD0812      JSR        2066(A5)                     ; A5 jump table
0032: 1D40FFC0      MOVE.B     D0,-64(A6)
0036: 486EFFC0      PEA        -64(A6)
003A: 4EAD02A2      JSR        674(A5)                      ; A5 jump table
003E: 4A86          TST.L      D6
...
0058: 4EAD005A      JSR        90(A5)                       ; A5 jump table
...
0096: 4EAD005A      JSR        90(A5)                       ; A5 jump table
...
00B6: 4EAD01A2      JSR        418(A5)                      ; A5 jump table
...
013A: 486D903E      PEA        -28610(A5)
013E: 4EAD029A      JSR        666(A5)                      ; A5 jump table
0142: 4EAD0672      JSR        1650(A5)                     ; A5 jump table
0146: 4CEE          DC.W       $4CEE
0148: 1CF8F6F6      MOVE.B     $F6F6.W,(A6)+
014C: 4E5E          UNLK       A6
014E: 4E75          RTS        
0150: 3F3C0121      MOVE.W     #$0121,-(A7)
0154: 486DD76C      PEA        -10388(A5)
0158: 4EAD0D7A      JSR        3450(A5)                     ; A5 jump table
015C: 4A40          TST.W      D0
...
01B0: 222DA5DE      MOVE.L     -23074(A5),D1                ; global A5-23074
01B4: D2ADA5E2      MOVE.B     -23070(A5),(A1)              ; global A5-23070
01B8: D2ADA5E6      MOVE.B     -23066(A5),(A1)              ; global A5-23066
01BC: D0AC0018      MOVE.B     24(A4),(A0)
01C0: B280          MOVE.W     D0,(A1)
01C2: 6C10          BGE.S      $01D4
01C4: 41EDA5CE      LEA        -23090(A5),A0                ; global at A5-23090
01C8: 43D4          LEA        (A4),A1
...
01D6: 4E5E          UNLK       A6
01D8: 4E75          RTS        
01DA: 4E56FF80      LINK       A6,#-128                     ; frame 128 bytes
01DE: 48E70108      MOVEM.L    D7/A4,-(SP)                  ; save regs
01E2: 286E0008      MOVEA.L    8(A6),A4
01E6: 2F0C          MOVE.L     A4,-(A7)
01E8: 4EAD096A      JSR        2410(A5)                     ; A5 jump table
01EC: 486EFF80      PEA        -128(A6)
01F0: 4EAD095A      JSR        2394(A5)                     ; A5 jump table
...
0214: 4EAD089A      JSR        2202(A5)                     ; A5 jump table
...
0236: 4EAD0A1A      JSR        2586(A5)                     ; A5 jump table
023A: 5C8F          MOVE.B     A7,(A6)
023C: 600C          BRA.S      $024A
023E: 486D0842      PEA        2114(A5)
0242: 2F0C          MOVE.L     A4,-(A7)
0244: 4EAD0852      JSR        2130(A5)                     ; A5 jump table
0248: 508F          MOVE.B     A7,(A0)
024A: 41EDA5CE      LEA        -23090(A5),A0                ; global at A5-23090
024E: 43EDA5F0      LEA        -23056(A5),A1                ; global at A5-23056
0252: 7007          MOVEQ      #7,D0
0254: 20D9          MOVE.L     (A1)+,(A0)+
0256: 51C8FFFC      DBF        D0,$0254                     ; loop
025A: 30D9          MOVE.W     (A1)+,(A0)+
025C: 4CDF1080      MOVEM.L    (SP)+,D7/A4                  ; restore regs
0260: 4E5E          UNLK       A6
0262: 4E75          RTS        
0264: 4E56F468      LINK       A6,#-2968                    ; frame 2968 bytes
0268: 48780B98      PEA        $0B98.W
026C: 486EF468      PEA        -2968(A6)
0270: 4EAD01AA      JSR        426(A5)                      ; A5 jump table
...
0294: 486DD76C      PEA        -10388(A5)
0298: 4EAD0D7A      JSR        3450(A5)                     ; A5 jump table
029C: 4A40          TST.W      D0
...
02BE: 4E5E          UNLK       A6
02C0: 4E75          RTS        
02C2: 4E56F8F0      LINK       A6,#-1808                    ; frame 1808 bytes
02C6: 48E71F38      MOVEM.L    D3/D4/D5/D6/D7/A2/A3/A4,-(SP) ; save regs
02CA: 282E000C      MOVE.L     12(A6),D4
02CE: 206DD13C      MOVEA.L    -11972(A5),A0
02D2: 4AA80004      TST.L      4(A0)
02D6: 6710          BEQ.S      $02E8
02D8: 2F2DD13C      MOVE.L     -11972(A5),-(A7)             ; global A5-11972
02DC: 206DD13C      MOVEA.L    -11972(A5),A0
02E0: 20680004      MOVEA.L    4(A0),A0
02E4: 4E90          JSR        (A0)
02E6: 588F          MOVE.B     A7,(A4)
02E8: 48780220      PEA        $0220.W
02EC: 486DBCFE      PEA        -17154(A5)
02F0: 486EFD58      PEA        -680(A6)
02F4: 4EAD0D8A      JSR        3466(A5)                     ; A5 jump table
02F8: 48780440      PEA        $0440.W
02FC: 486DBF1E      PEA        -16610(A5)
0300: 486EF918      PEA        -1768(A6)
0304: 4EAD0D8A      JSR        3466(A5)                     ; A5 jump table
0308: 486DC366      PEA        -15514(A5)
030C: 486EF910      PEA        -1776(A6)
0310: 4EAD0DA2      JSR        3490(A5)                     ; A5 jump table
0314: 486DC35E      PEA        -15522(A5)
0318: 486EF908      PEA        -1784(A6)
031C: 4EAD0DA2      JSR        3490(A5)                     ; A5 jump table
0320: 41EDC366      LEA        -15514(A5),A0                ; global at A5-15514
0324: 2D48F8F0      MOVE.L     A0,-1808(A6)
0328: 41EDC35E      LEA        -15522(A5),A0                ; global at A5-15522
...
0354: D7EDD13C244B  MOVE.B     -11972(A5),75(PC,D2.W)       ; global A5-11972
035A: D9AB002A206D  MOVE.B     42(A3),109(A4,D2.W)
0360: D13C4A68      MOVE.B     #$68,-(A0)
0364: 00166734      ORI.B      #$6734,(A6)
0368: 48780121      PEA        $0121.W
036C: 486DD76C      PEA        -10388(A5)
0370: 4EAD01AA      JSR        426(A5)                      ; A5 jump table
0374: 48780121      PEA        $0121.W
0378: 486DD88D      PEA        -10099(A5)
037C: 4EAD01AA      JSR        426(A5)                      ; A5 jump table
0380: 486D0402      PEA        1026(A5)
0384: 4EAD042A      JSR        1066(A5)                     ; A5 jump table
0388: 4EAD0552      JSR        1362(A5)                     ; A5 jump table
038C: 4EAD051A      JSR        1306(A5)                     ; A5 jump table
0390: 7078          MOVEQ      #120,D0
0392: 2E80          MOVE.L     D0,(A7)
0394: 4EAD06D2      JSR        1746(A5)                     ; A5 jump table
0398: 4FEF0014      LEA        20(A7),A7
039C: 2F2EF8F0      MOVE.L     -1808(A6),-(A7)
03A0: 4EAD096A      JSR        2410(A5)                     ; A5 jump table
03A4: 4257          CLR.W      (A7)
03A6: 2F2EF8F0      MOVE.L     -1808(A6),-(A7)
03AA: 2F0A          MOVE.L     A2,-(A7)
03AC: 4EAD0942      JSR        2370(A5)                     ; A5 jump table
...
03C6: 4EAD016A      JSR        362(A5)                      ; A5 jump table
03CA: 4EAD04D2      JSR        1234(A5)                     ; A5 jump table
...
03E6: 4EAD0DA2      JSR        3490(A5)                     ; A5 jump table
...
03FA: 4EAD0542      JSR        1346(A5)                     ; A5 jump table
03FE: 2EAEF8FC      MOVE.L     -1796(A6),(A7)
0402: 2F2D9028      MOVE.L     -28632(A5),-(A7)             ; global A5-28632
0406: 486EFF78      PEA        -136(A6)
040A: 4EAD0812      JSR        2066(A5)                     ; A5 jump table
040E: 48C0          EXT.L      D0
...
0420: 4EAD06DA      JSR        1754(A5)                     ; A5 jump table
...
043A: 4EAD0962      JSR        2402(A5)                     ; A5 jump table
...
0458: 486DC366      PEA        -15514(A5)
045C: 486EFFF8      PEA        -8(A6)
0460: 4EAD0DA2      JSR        3490(A5)                     ; A5 jump table
0464: 2E93          MOVE.L     (A3),(A7)
0466: 486DC366      PEA        -15514(A5)
046A: 4EAD0DA2      JSR        3490(A5)                     ; A5 jump table
046E: 4EAD0552      JSR        1362(A5)                     ; A5 jump table
0472: 486EFFF8      PEA        -8(A6)
0476: 486DC366      PEA        -15514(A5)
047A: 4EAD0DA2      JSR        3490(A5)                     ; A5 jump table
047E: 4EAD04E2      JSR        1250(A5)                     ; A5 jump table
0482: 4EAD04D2      JSR        1234(A5)                     ; A5 jump table
0486: 7078          MOVEQ      #120,D0
0488: 2E80          MOVE.L     D0,(A7)
048A: 4EAD06D2      JSR        1746(A5)                     ; A5 jump table
...
04A0: 486DA5CE      PEA        -23090(A5)
04A4: 4EAD0942      JSR        2370(A5)                     ; A5 jump table
04A8: 2E93          MOVE.L     (A3),(A7)
04AA: 4EAD0962      JSR        2402(A5)                     ; A5 jump table
...
04DE: 486DA5CE      PEA        -23090(A5)
04E2: 4EAD016A      JSR        362(A5)                      ; A5 jump table
04E6: 508F          MOVE.B     A7,(A0)
04E8: 202DA5DE      MOVE.L     -23074(A5),D0                ; global A5-23074
...
053C: 4EAD084A      JSR        2122(A5)                     ; A5 jump table
...
0592: 4EAD0042      JSR        66(A5)                       ; A5 jump table
0596: 222DD13C      MOVE.L     -11972(A5),D1                ; global A5-11972
...
05B6: 4EAD005A      JSR        90(A5)                       ; A5 jump table
05BA: 2F00          MOVE.L     D0,-(A7)
05BC: 486D9058      PEA        -28584(A5)
05C0: 486EFF78      PEA        -136(A6)
05C4: 4EAD0812      JSR        2066(A5)                     ; A5 jump table
05C8: 48C0          EXT.L      D0
...
0600: 202DD13C      MOVE.L     -11972(A5),D0                ; global A5-11972
0604: D9B4083E4878  MOVE.B     62(A4,D0.L),120(A4,D4.L)
060A: 0220486E      ANDI.B     #$486E,-(A0)
060E: FD58486D      MOVE.W     (A0)+,18541(A6)
0612: BCFE          MOVE.W     ???,(A6)+
0614: 4EAD0D8A      JSR        3466(A5)                     ; A5 jump table
0618: 48780440      PEA        $0440.W
061C: 486EF918      PEA        -1768(A6)
0620: 486DBF1E      PEA        -16610(A5)
0624: 4EAD0D8A      JSR        3466(A5)                     ; A5 jump table
0628: 486EF910      PEA        -1776(A6)
062C: 486DC366      PEA        -15514(A5)
0630: 4EAD0DA2      JSR        3490(A5)                     ; A5 jump table
...
064E: 486DC35E      PEA        -15522(A5)
0652: 4EAD0DA2      JSR        3490(A5)                     ; A5 jump table
...
066E: 2B6D93ACA222  MOVE.L     -27732(A5),-24030(A5)        ; global A5-27732
0674: 536DA386702C  MOVE.B     -23674(A5),28716(A1)         ; global A5-23674
067A: C1EDA386      ANDA.L     -23674(A5),A0
067E: 41EDA226      LEA        -24026(A5),A0                ; global at A5-24026
...
0696: 4CDF1CF8      MOVEM.L    (SP)+,D3/D4/D5/D6/D7/A2/A3/A4 ; restore regs
069A: 4E5E          UNLK       A6
069C: 4E75          RTS        
069E: 4E56E690      LINK       A6,#-6512                    ; frame 6512 bytes
...
06C6: 4EAD059A      JSR        1434(A5)                     ; A5 jump table
06CA: 548F          MOVE.B     A7,(A2)
06CC: 42ADB3E2      CLR.L      -19486(A5)
06D0: 3F3C0121      MOVE.W     #$0121,-(A7)
06D4: 486DD76C      PEA        -10388(A5)
06D8: 4EAD0D7A      JSR        3450(A5)                     ; A5 jump table
06DC: 4A40          TST.W      D0
06DE: 5C8F          MOVE.B     A7,(A6)
06E0: 6604          BNE.S      $06E6
06E2: 4EAD01A2      JSR        418(A5)                      ; A5 jump table
06E6: 0C6D0008A386  CMPI.W     #$0008,-23674(A5)
06EC: 6406          BCC.S      $06F4
06EE: 4A6DA386      TST.W      -23674(A5)
06F2: 6C04          BGE.S      $06F8
06F4: 4EAD01A2      JSR        418(A5)                      ; A5 jump table
06F8: 302DA386      MOVE.W     -23674(A5),D0                ; global A5-23674
...
071C: 41EDC35E      LEA        -15522(A5),A0                ; global at A5-15522
...
074E: 486DD76C      PEA        -10388(A5)
0752: 4EAD01AA      JSR        426(A5)                      ; A5 jump table
0756: 48780121      PEA        $0121.W
075A: 486DD88D      PEA        -10099(A5)
075E: 4EAD01AA      JSR        426(A5)                      ; A5 jump table
0762: 4EAD051A      JSR        1306(A5)                     ; A5 jump table
0766: 4FEF0010      LEA        16(A7),A7
076A: 48780220      PEA        $0220.W
076E: 486DBCFE      PEA        -17154(A5)
0772: 4EAD01AA      JSR        426(A5)                      ; A5 jump table
0776: 48780440      PEA        $0440.W
077A: 486DBF1E      PEA        -16610(A5)
077E: 4EAD01AA      JSR        426(A5)                      ; A5 jump table
0782: 7008          MOVEQ      #8,D0
0784: 2E80          MOVE.L     D0,(A7)
0786: 486DC366      PEA        -15514(A5)
078A: 4EAD01AA      JSR        426(A5)                      ; A5 jump table
078E: 7008          MOVEQ      #8,D0
0790: 2E80          MOVE.L     D0,(A7)
0792: 486DC35E      PEA        -15522(A5)
0796: 4EAD01AA      JSR        426(A5)                      ; A5 jump table
079A: 42ADC372      CLR.L      -15502(A5)
079E: 42ADC36E      CLR.L      -15506(A5)
07A2: 41EDC35E      LEA        -15522(A5),A0                ; global at A5-15522
07A6: B1EEE7B04FEF  MOVE.W     -6224(A6),$4FEF.W
07AC: 00186608      ORI.B      #$6608,(A0)+
07B0: 41EDC366      LEA        -15514(A5),A0                ; global at A5-15514
07B4: 2008          MOVE.L     A0,D0
07B6: 6006          BRA.S      $07BE
07B8: 41EDC35E      LEA        -15522(A5),A0                ; global at A5-15522
07BC: 2008          MOVE.L     A0,D0
07BE: 2B40C376      MOVE.L     D0,-15498(A5)
07C2: 2D40E7B0      MOVE.L     D0,-6224(A6)
07C6: 486DC366      PEA        -15514(A5)
07CA: 4EAD0962      JSR        2402(A5)                     ; A5 jump table
07CE: 486DC35E      PEA        -15522(A5)
07D2: 4EAD0962      JSR        2402(A5)                     ; A5 jump table
...
0816: 486DC366      PEA        -15514(A5)
081A: 486EFFF0      PEA        -16(A6)
081E: 4EAD0DA2      JSR        3490(A5)                     ; A5 jump table
0822: 2EADC376      MOVE.L     -15498(A5),(A7)              ; global A5-15498
0826: 486DC366      PEA        -15514(A5)
082A: 4EAD0DA2      JSR        3490(A5)                     ; A5 jump table
082E: 4EAD0552      JSR        1362(A5)                     ; A5 jump table
0832: 4EAD03C2      JSR        962(A5)                      ; A5 jump table
0836: 486EFFF0      PEA        -16(A6)
083A: 486DC366      PEA        -15514(A5)
083E: 4EAD0DA2      JSR        3490(A5)                     ; A5 jump table
0842: 4FEF0014      LEA        20(A7),A7
0846: 4EAD0672      JSR        1650(A5)                     ; A5 jump table
084A: 4EAD06CA      JSR        1738(A5)                     ; A5 jump table
084E: 2F2DC376      MOVE.L     -15498(A5),-(A7)             ; global A5-15498
0852: 4EBAF986      JSR        -1658(PC)
0856: 4EAD093A      JSR        2362(A5)                     ; A5 jump table
085A: 4A40          TST.W      D0
085C: 588F          MOVE.B     A7,(A4)
085E: 66000178      BNE.W      $09DA
0862: 486DC35E      PEA        -15522(A5)
0866: 4EAD0DC2      JSR        3522(A5)                     ; A5 jump table
086A: 5F80588F      MOVE.B     D0,-113(A7,D5.L)
086E: 6704          BEQ.S      $0874
0870: 4EAD01A2      JSR        418(A5)                      ; A5 jump table
0874: 486DC366      PEA        -15514(A5)
0878: 4EAD0DC2      JSR        3522(A5)                     ; A5 jump table
087C: 5F80588F      MOVE.B     D0,-113(A7,D5.L)
0880: 6704          BEQ.S      $0886
0882: 4EAD01A2      JSR        418(A5)                      ; A5 jump table
0886: 48780022      PEA        $0022.W
088A: 486DA5CE      PEA        -23090(A5)
088E: 4EAD01AA      JSR        426(A5)                      ; A5 jump table
...
0912: 4EAD0042      JSR        66(A5)                       ; A5 jump table
...
096E: 202DA5DE      MOVE.L     -23074(A5),D0                ; global A5-23074
0972: D0ADA5E2      MOVE.B     -23070(A5),(A0)              ; global A5-23070
...
09A0: D0ADA5E6      MOVE.B     -23066(A5),(A0)              ; global A5-23066
...
09E2: 2F2DC376      MOVE.L     -15498(A5),-(A7)             ; global A5-15498
09E6: 4EAD0542      JSR        1346(A5)                     ; A5 jump table
09EA: 2EADC376      MOVE.L     -15498(A5),(A7)              ; global A5-15498
09EE: 2F2D9028      MOVE.L     -28632(A5),-(A7)             ; global A5-28632
09F2: 486EE72C      PEA        -6356(A6)
09F6: 4EAD0812      JSR        2066(A5)                     ; A5 jump table
...
0A0E: 4EAD06DA      JSR        1754(A5)                     ; A5 jump table
0A12: 206DD13C      MOVEA.L    -11972(A5),A0
0A16: 3EA8000A      MOVE.W     10(A0),(A7)
0A1A: 486DA5CE      PEA        -23090(A5)
0A1E: 4EBA067C      JSR        1660(PC)
0A22: 4FEF001A      LEA        26(A7),A7
0A26: 2F2EE7CE      MOVE.L     -6194(A6),-(A7)
0A2A: 2F2EE7DA      MOVE.L     -6182(A6),-(A7)
0A2E: 486DA5CE      PEA        -23090(A5)
0A32: 4EAD09E2      JSR        2530(A5)                     ; A5 jump table
0A36: 2D6DA5DEE7C0  MOVE.L     -23074(A5),-6208(A6)         ; global A5-23074
0A3C: 48780080      PEA        $0080.W
0A40: 486DA54E      PEA        -23218(A5)
0A44: 486EE690      PEA        -6512(A6)
0A48: 4EAD0D8A      JSR        3466(A5)                     ; A5 jump table
...
0A7C: 4257          CLR.W      (A7)
0A7E: 2F2DC376      MOVE.L     -15498(A5),-(A7)             ; global A5-15498
0A82: 486DA5CE      PEA        -23090(A5)
0A86: 4EAD0942      JSR        2370(A5)                     ; A5 jump table
0A8A: 526EE7C8      MOVEA.B    -6200(A6),A1
0A8E: 2EADC376      MOVE.L     -15498(A5),(A7)              ; global A5-15498
0A92: 4EAD0962      JSR        2402(A5)                     ; A5 jump table
0A96: 41EDC366      LEA        -15514(A5),A0                ; global at A5-15514
0A9A: B1EDC3764FEF  MOVE.W     -15498(A5),$4FEF.W           ; global A5-15498
0AA0: 00206612      ORI.B      #$6612,-(A0)
0AA4: 202DA5DE      MOVE.L     -23074(A5),D0                ; global A5-23074
0AA8: D1ADC37241ED  MOVE.B     -15502(A5),-19(A0,D4.W)      ; global A5-15502
0AAE: C35E          AND.W      D1,(A6)+
0AB0: 2B48C376      MOVE.L     A0,-15498(A5)
0AB4: 6010          BRA.S      $0AC6
0AB6: 202DA5DE      MOVE.L     -23074(A5),D0                ; global A5-23074
0ABA: D1ADC36E41ED  MOVE.B     -15506(A5),-19(A0,D4.W)      ; global A5-15506
...
0AD6: 486DA5CE      PEA        -23090(A5)
0ADA: 4EAD016A      JSR        362(A5)                      ; A5 jump table
0ADE: 4EAD04EA      JSR        1258(A5)                     ; A5 jump table
0AE2: 508F          MOVE.B     A7,(A0)
0AE4: 4EAD092A      JSR        2346(A5)                     ; A5 jump table
0AE8: 4A40          TST.W      D0
...
0AFA: 486DC35E      PEA        -15522(A5)
0AFE: 4EAD084A      JSR        2122(A5)                     ; A5 jump table
0B02: 48C0          EXT.L      D0
0B04: 91ADC36E486D  MOVE.B     -15506(A5),109(A0,D4.L)      ; global A5-15506
0B0A: C366          AND.W      D1,-(A6)
0B0C: 4EAD084A      JSR        2122(A5)                     ; A5 jump table
0B10: 48C0          EXT.L      D0
0B12: 91ADC372508F  MOVE.B     -15502(A5),-113(A0,D5.W)     ; global A5-15502
0B18: 6036          BRA.S      $0B50
0B1A: 4A2DC366      TST.B      -15514(A5)
0B1E: 6714          BEQ.S      $0B34
0B20: 486DC366      PEA        -15514(A5)
0B24: 4EAD084A      JSR        2122(A5)                     ; A5 jump table
0B28: D040          MOVEA.B    D0,A0
0B2A: 48C0          EXT.L      D0
0B2C: D1ADC36E588F  MOVE.B     -15506(A5),-113(A0,D5.L)     ; global A5-15506
0B32: 601C          BRA.S      $0B50
0B34: 4A2DC35E      TST.B      -15522(A5)
0B38: 6604          BNE.S      $0B3E
0B3A: 4EAD01A2      JSR        418(A5)                      ; A5 jump table
0B3E: 486DC35E      PEA        -15522(A5)
0B42: 4EAD084A      JSR        2122(A5)                     ; A5 jump table
0B46: D040          MOVEA.B    D0,A0
0B48: 48C0          EXT.L      D0
0B4A: D1ADC372588F  MOVE.B     -15502(A5),-113(A0,D5.L)     ; global A5-15502
0B50: 202DC36E      MOVE.L     -15506(A5),D0                ; global A5-15506
...
0B74: B2ADC36E      MOVE.W     -15506(A5),(A1)              ; global A5-15506
0B78: 6C08          BGE.S      $0B82
0B7A: 54AEE714      MOVE.B     -6380(A6),(A2)
0B7E: 6000FBC0      BRA.W      $0742
0B82: 202DC36E      MOVE.L     -15506(A5),D0                ; global A5-15506
0B86: B0ADC372      MOVE.W     -15502(A5),(A0)              ; global A5-15502
...
0BA0: 536DA3866042  MOVE.B     -23674(A5),24642(A1)         ; global A5-23674
0BA6: 2F2DA222      MOVE.L     -24030(A5),-(A7)             ; global A5-24030
0BAA: 2F2D93AC      MOVE.L     -27732(A5),-(A7)             ; global A5-27732
0BAE: 4EAD0DB2      JSR        3506(A5)                     ; A5 jump table
0BB2: 4A40          TST.W      D0
0BB4: 508F          MOVE.B     A7,(A0)
0BB6: 6730          BEQ.S      $0BE8
0BB8: 4A6DA386      TST.W      -23674(A5)
0BBC: 6E04          BGT.S      $0BC2
0BBE: 4EAD01A2      JSR        418(A5)                      ; A5 jump table
0BC2: 2B6DA222A222  MOVE.L     -24030(A5),-24030(A5)        ; global A5-24030
0BC8: 536DA386702C  MOVE.B     -23674(A5),28716(A1)         ; global A5-23674
0BCE: C1EDA386      ANDA.L     -23674(A5),A0
0BD2: 41EDA226      LEA        -24026(A5),A0                ; global at A5-24026
...
0BEC: 486DBCFE      PEA        -17154(A5)
0BF0: 4EAD01AA      JSR        426(A5)                      ; A5 jump table
0BF4: 48780440      PEA        $0440.W
0BF8: 486DBF1E      PEA        -16610(A5)
0BFC: 4EAD01AA      JSR        426(A5)                      ; A5 jump table
0C00: 7008          MOVEQ      #8,D0
0C02: 2E80          MOVE.L     D0,(A7)
0C04: 486DC366      PEA        -15514(A5)
0C08: 4EAD01AA      JSR        426(A5)                      ; A5 jump table
0C0C: 7008          MOVEQ      #8,D0
0C0E: 2E80          MOVE.L     D0,(A7)
0C10: 486DC35E      PEA        -15522(A5)
0C14: 4EAD01AA      JSR        426(A5)                      ; A5 jump table
...
0C3C: 4EAD040A      JSR        1034(A5)                     ; A5 jump table
0C40: 4EAD0552      JSR        1362(A5)                     ; A5 jump table
0C44: 4EAD04EA      JSR        1258(A5)                     ; A5 jump table
0C48: 4EAD03C2      JSR        962(A5)                      ; A5 jump table
0C4C: 4EAD06B2      JSR        1714(A5)                     ; A5 jump table
0C50: 4E5E          UNLK       A6
0C52: 4E75          RTS        
0C54: 4E56F98C      LINK       A6,#-1652                    ; frame 1652 bytes
0C58: 2B6E0008D13C  MOVE.L     8(A6),-11972(A5)
0C5E: 4EAD06AA      JSR        1706(A5)                     ; A5 jump table
...
0C80: 4EAD059A      JSR        1434(A5)                     ; A5 jump table
0C84: 548F          MOVE.B     A7,(A2)
0C86: 42ADB3E2      CLR.L      -19486(A5)
0C8A: 48780220      PEA        $0220.W
0C8E: 486DBCFE      PEA        -17154(A5)
0C92: 486EFDE0      PEA        -544(A6)
0C96: 4EAD0D8A      JSR        3466(A5)                     ; A5 jump table
0C9A: 48780440      PEA        $0440.W
0C9E: 486DBF1E      PEA        -16610(A5)
0CA2: 486EF9A0      PEA        -1632(A6)
0CA6: 4EAD0D8A      JSR        3466(A5)                     ; A5 jump table
0CAA: 486DC366      PEA        -15514(A5)
0CAE: 486EF998      PEA        -1640(A6)
0CB2: 4EAD0DA2      JSR        3490(A5)                     ; A5 jump table
0CB6: 486DC35E      PEA        -15522(A5)
0CBA: 486EF990      PEA        -1648(A6)
0CBE: 4EAD0DA2      JSR        3490(A5)                     ; A5 jump table
0CC2: 2D6DC376F98C  MOVE.L     -15498(A5),-1652(A6)         ; global A5-15498
...
0CDA: 4EAD01A2      JSR        418(A5)                      ; A5 jump table
0CDE: 302DA386      MOVE.W     -23674(A5),D0                ; global A5-23674
...
0D0A: 486D00BA      PEA        186(A5)
0D0E: 4EAD0A42      JSR        2626(A5)                     ; A5 jump table
0D12: 206DD13C      MOVEA.L    -11972(A5),A0
0D16: 4AA80004      TST.L      4(A0)
0D1A: 588F          MOVE.B     A7,(A4)
0D1C: 671C          BEQ.S      $0D3A
0D1E: 2F2DD13C      MOVE.L     -11972(A5),-(A7)             ; global A5-11972
0D22: 206DD13C      MOVEA.L    -11972(A5),A0
0D26: 20680004      MOVEA.L    4(A0),A0
0D2A: 4E90          JSR        (A0)
0D2C: 588F          MOVE.B     A7,(A4)
0D2E: 600A          BRA.S      $0D3A
0D30: 486D00BA      PEA        186(A5)
0D34: 4EAD0A4A      JSR        2634(A5)                     ; A5 jump table
0D38: 588F          MOVE.B     A7,(A4)
0D3A: 536DA3866042  MOVE.B     -23674(A5),24642(A1)         ; global A5-23674
0D40: 2F2DA222      MOVE.L     -24030(A5),-(A7)             ; global A5-24030
0D44: 2F2D93AC      MOVE.L     -27732(A5),-(A7)             ; global A5-27732
0D48: 4EAD0DB2      JSR        3506(A5)                     ; A5 jump table
0D4C: 4A40          TST.W      D0
0D4E: 508F          MOVE.B     A7,(A0)
0D50: 6730          BEQ.S      $0D82
0D52: 4A6DA386      TST.W      -23674(A5)
0D56: 6E04          BGT.S      $0D5C
0D58: 4EAD01A2      JSR        418(A5)                      ; A5 jump table
0D5C: 2B6DA222A222  MOVE.L     -24030(A5),-24030(A5)        ; global A5-24030
0D62: 536DA386702C  MOVE.B     -23674(A5),28716(A1)         ; global A5-23674
0D68: C1EDA386      ANDA.L     -23674(A5),A0
0D6C: 41EDA226      LEA        -24026(A5),A0                ; global at A5-24026
...
0D8A: 486DBCFE      PEA        -17154(A5)
0D8E: 4EAD0D8A      JSR        3466(A5)                     ; A5 jump table
0D92: 48780440      PEA        $0440.W
0D96: 486EF9A0      PEA        -1632(A6)
0D9A: 486DBF1E      PEA        -16610(A5)
0D9E: 4EAD0D8A      JSR        3466(A5)                     ; A5 jump table
0DA2: 486EF998      PEA        -1640(A6)
0DA6: 486DC366      PEA        -15514(A5)
0DAA: 4EAD0DA2      JSR        3490(A5)                     ; A5 jump table
0DAE: 486EF990      PEA        -1648(A6)
0DB2: 486DC35E      PEA        -15522(A5)
0DB6: 4EAD0DA2      JSR        3490(A5)                     ; A5 jump table
0DBA: 2B6EF98CC376  MOVE.L     -1652(A6),-15498(A5)
0DC0: 41EDC366      LEA        -15514(A5),A0                ; global at A5-15514
0DC4: B1EDC3764FEF  MOVE.W     -15498(A5),$4FEF.W           ; global A5-15498
0DCA: 002867044EAD  ORI.B      #$6704,20141(A0)
0DD0: 01A2          DC.W       $01A2
0DD2: 2F2DC376      MOVE.L     -15498(A5),-(A7)             ; global A5-15498
0DD6: 4EAD096A      JSR        2410(A5)                     ; A5 jump table
0DDA: 4EAD099A      JSR        2458(A5)                     ; A5 jump table
...
0E02: 4EAD040A      JSR        1034(A5)                     ; A5 jump table
0E06: 4EAD0552      JSR        1362(A5)                     ; A5 jump table
0E0A: 4EAD06B2      JSR        1714(A5)                     ; A5 jump table
0E0E: 4E5E          UNLK       A6
0E10: 4E75          RTS        
...
0E1A: 4E5E          UNLK       A6
0E1C: 4E75          RTS        
0E1E: 4E56FF80      LINK       A6,#-128                     ; frame 128 bytes
0E22: 2F0C          MOVE.L     A4,-(A7)
0E24: 3F3C0004      MOVE.W     #$0004,-(A7)
0E28: 2F2D9078      MOVE.L     -28552(A5),-(A7)             ; global A5-28552
0E2C: 4EAD05F2      JSR        1522(A5)                     ; A5 jump table
...
0ECA: 4EAD0D0A      JSR        3338(A5)                     ; A5 jump table
0ECE: 2EADA1F6      MOVE.L     -24074(A5),(A7)              ; global A5-24074
0ED2: 3F3C0005      MOVE.W     #$0005,-(A7)
0ED6: 2F2E0008      MOVE.L     8(A6),-(A7)
0EDA: 4EAD0CD2      JSR        3282(A5)                     ; A5 jump table
0EDE: 4E5E          UNLK       A6
0EE0: 4E75          RTS        
0EE2: 4E560000      LINK       A6,#0
0EE6: 42A7          CLR.L      -(A7)
0EE8: 486D0092      PEA        146(A5)
0EEC: 2F2DA21E      MOVE.L     -24034(A5),-(A7)             ; global A5-24034
0EF0: 3F3C03F7      MOVE.W     #$03F7,-(A7)
0EF4: 4EAD0C92      JSR        3218(A5)                     ; A5 jump table
0EF8: 4E5E          UNLK       A6
0EFA: 4E75          RTS        
0EFC: 4E56FFFE      LINK       A6,#-2                       ; frame 2 bytes
0F00: 2B6E00089078  MOVE.L     8(A6),-28552(A5)
0F06: 4EBAFF16      JSR        -234(PC)
0F0A: 486D0C8A      PEA        3210(A5)
...
0F3A: 2F2D9078      MOVE.L     -28552(A5),-(A7)             ; global A5-28552
0F3E: 4EAD05F2      JSR        1522(A5)                     ; A5 jump table
0F42: 2E80          MOVE.L     D0,(A7)
0F44: 4EAD05D2      JSR        1490(A5)                     ; A5 jump table
...
0F68: 4E56FDFC      LINK       A6,#-516                     ; frame 516 bytes
0F6C: 48E70F38      MOVEM.L    D4/D5/D6/D7/A2/A3/A4,-(SP)   ; save regs
0F70: 286E0008      MOVEA.L    8(A6),A4
0F74: 3F3C0004      MOVE.W     #$0004,-(A7)
0F78: 2F2D9078      MOVE.L     -28552(A5),-(A7)             ; global A5-28552
0F7C: 4EAD05E2      JSR        1506(A5)                     ; A5 jump table
0F80: 39400012      MOVE.W     D0,18(A4)
0F84: 3EBC0003      MOVE.W     #$0003,(A7)
0F88: 2F2D9078      MOVE.L     -28552(A5),-(A7)             ; global A5-28552
0F8C: 4EAD05E2      JSR        1506(A5)                     ; A5 jump table
0F90: 39400014      MOVE.W     D0,20(A4)
0F94: 3EBC0002      MOVE.W     #$0002,(A7)
0F98: 2F2D9078      MOVE.L     -28552(A5),-(A7)             ; global A5-28552
0F9C: 4EAD05E2      JSR        1506(A5)                     ; A5 jump table
0FA0: 3940000A      MOVE.W     D0,10(A4)
0FA4: 3EBC0008      MOVE.W     #$0008,(A7)
0FA8: 2F2D9078      MOVE.L     -28552(A5),-(A7)             ; global A5-28552
0FAC: 4EAD05E2      JSR        1506(A5)                     ; A5 jump table
0FB0: 39400010      MOVE.W     D0,16(A4)
0FB4: 3EBC000A      MOVE.W     #$000A,(A7)
0FB8: 2F2D9078      MOVE.L     -28552(A5),-(A7)             ; global A5-28552
0FBC: 4EAD05E2      JSR        1506(A5)                     ; A5 jump table
0FC0: 39400016      MOVE.W     D0,22(A4)
0FC4: 486EFF00      PEA        -256(A6)
0FC8: 3F3C0005      MOVE.W     #$0005,-(A7)
0FCC: 2F2D9078      MOVE.L     -28552(A5),-(A7)             ; global A5-28552
0FD0: 4EAD0642      JSR        1602(A5)                     ; A5 jump table
0FD4: 486C0008      PEA        8(A4)
0FD8: 486D907E      PEA        -28546(A5)
0FDC: 486EFF00      PEA        -256(A6)
0FE0: 4EAD081A      JSR        2074(A5)                     ; A5 jump table
0FE4: 4297          CLR.L      (A7)
0FE6: 48780007      PEA        $0007.W
0FEA: 2F2D9078      MOVE.L     -28552(A5),-(A7)             ; global A5-28552
0FEE: 4EAD01EA      JSR        490(A5)                      ; A5 jump table
0FF2: 3EBC0121      MOVE.W     #$0121,(A7)
0FF6: 486DD76C      PEA        -10388(A5)
0FFA: 4EAD0D7A      JSR        3450(A5)                     ; A5 jump table
0FFE: 4A40          TST.W      D0
...
1046: 41ED00B2      LEA        178(A5),A0                   ; global at A5+178
...
1094: 4CDF1CF0      MOVEM.L    (SP)+,D4/D5/D6/D7/A2/A3/A4   ; restore regs
1098: 4E5E          UNLK       A6
109A: 4E75          RTS        
109C: 4E56FF7C      LINK       A6,#-132                     ; frame 132 bytes
...
10BA: 486D9082      PEA        -28542(A5)
10BE: 486EFF80      PEA        -128(A6)
10C2: 4EAD0812      JSR        2066(A5)                     ; A5 jump table
...
10DA: 4EAD0B32      JSR        2866(A5)                     ; A5 jump table
10DE: 4A5F          TST.W      (A7)+
10E0: 4FEF0014      LEA        20(A7),A7
10E4: 6704          BEQ.S      $10EA
10E6: 4EAD01A2      JSR        418(A5)                      ; A5 jump table
10EA: 285F          MOVEA.L    (A7)+,A4
10EC: 4E5E          UNLK       A6
10EE: 4E75          RTS        
10F0: 4E56FFFE      LINK       A6,#-2                       ; frame 2 bytes
10F4: 2F3C54455854  MOVE.L     #$54455854,-(A7)
10FA: 3F3C0001      MOVE.W     #$0001,-(A7)
10FE: 486EFFFE      PEA        -2(A6)
1102: 4267          CLR.W      -(A7)
1104: 486D9092      PEA        -28526(A5)
1108: 4EAD0D32      JSR        3378(A5)                     ; A5 jump table
...
111E: 4EAD0B22      JSR        2850(A5)                     ; A5 jump table
1122: 4E5E          UNLK       A6
1124: 4E75          RTS        
